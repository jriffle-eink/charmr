...
# retrives from user input - probably in controller or model (or both?...) Actually probably in model, to help construct the model. Controller just for user input to run program            
...
# reload and reimport are the same...?
def RELOAD():
    import charmr_module as cm
    reload(cm)
    REIMPORT()
    
# never used ... can probably remove
def REIMPORT():
    import charmr_module as cm
    reload(cm)
    
# in model -> use for model construction/reconstruction
